        ...
        <div className="container" >
            {status === 1 ? <div className="second">
                ...
                <form className="form" onSubmit={sendFirst}>
                    ...
                    <div className="next">
                        <button className="btn_submit" disabled={isLoading}> {isLoading && <span className="spinner-border spinner-border-sm mr-2 text-dark"/>}Продолжить</button>
                    </div>
                </form>
                ...
                <form className="form" onSubmit={submitForm}>
                    ...
                    <input  id="name"  value={data.fullName}  disabled autoComplete="off" ref={inputValue2} type="text"/>
                ...
                <form className="form" onSubmit={submitForm}>
                    ...
                    <div className={`${loading ? "active" : ""}  five`}>
                        ...
                        {loading ? <div className="spinner"> <Spinner animation="border" variant="danger" /> <p>Желательно не закрывайте это
                            окно или приложение.</p></div> : <form className="form" onSubmit={submitForm}>
                ...
                <div className="last">
                    ...
                    <div>
                        ...
                        <button className="btn_submit" type="button" onClick={() => setStatus(1)}>Ваши заказы</button>
                    </div>
                </div>}
